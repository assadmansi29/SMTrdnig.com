      ...
      <div className="bg-[#0D121F] border border-amber-500/40 rounded-2xl w-full max-w-lg shadow-2xl overflow-hidden text-slate-200 relative">
        ...
        {subscribed ? (
          <div className="p-8 text-center space-y-4">
            ...
            <h3 className="font-extrabold text-xl text-white">Welcome to the SMTrading Alpha Desk</h3>
            <p className="text-xs text-slate-300 max-w-sm mx-auto leading-relaxed">
              We've dispatched this week's Institutional Liquidity & Cointegration Briefing directly to <strong className="text-amber-300">{email}</strong>.
            </p>
            <button
              onClick={onClose}
          ...
          <div className="p-6 sm:p-8 space-y-6">
            <div className="space-y-2">
              <div className="inline-flex items-center gap-1.5 bg-amber-400/10 text-amber-300 text-[11px] font-bold px-2.5 py-1 rounded-md border border-amber-400/30">
                ...
                SMTrading.com VIP Alpha Dispatch
              </div>
              <h2 className="font-extrabold text-2xl text-white">
                Institutional Macro & Order Flow Intelligence
              </h2>
              <p className="text-xs text-slate-400 leading-relaxed">
                Join 45,000+ proprietary traders, hedge fund analysts, and quantitative researchers receiving our weekly sovereign liquidity models and algorithmic setups.
              </p>
            </div>
            ...
            <div className="bg-[#080B12] p-4 rounded-xl border border-slate-800 space-y-2.5 text-xs text-slate-300">
              <div className="flex items-center gap-2">
                ...
                <span>Weekly CFTC Commitment of Traders (COT) Institutional Breakdown</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="w-1.5 h-1.5 rounded-full bg-emerald-400"></span>
                <span>Real-Time Volatility Skew & Gamma Regime Flips</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="w-1.5 h-1.5 rounded-full bg-cyan-400"></span>
                <span>Open-source Python Statistical Arbitrage Notebooks</span>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-[#070A10] border border-slate-700 rounded-xl pl-10 pr-4 py-2.5 text-xs sm:text-sm text-white placeholder:text-slate-500 focus:border-amber-400 focus:outline-none"
                />
              </div>
              ...
              >
                Access Free Weekly Alpha Dispatch
              </button>
            </form>

            <div className="flex items-center justify-center gap-2 text-[11px] text-slate-500">
              <ShieldCheck className="w-3.5 h-3.5 text-emerald-500" />
              <span>Zero spam. Strict institutional privacy. Unsubscribe anytime.</span>
            </div>
          </div>
        )}
      </div>
