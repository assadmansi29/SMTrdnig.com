      ...
      <header className="sticky top-0 z-40 bg-[#070A12]/90 backdrop-blur-xl border-b border-slate-800/80">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 sm:h-20 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 min-w-0">
            <div className="w-9 h-9 sm:w-11 sm:h-11 rounded-2xl bg-gradient-to-br from-amber-400 via-amber-500 to-amber-700 p-[1.5px] shadow-lg shadow-amber-500/20 shrink-0">
              <div className="w-full h-full bg-[#0B0F1C] rounded-[14px] flex items-center justify-center">
            ...
            <div className="min-w-0">
              <div className="flex items-center gap-1.5 flex-wrap">
                ...
                <div className="inline-flex items-center gap-1 bg-amber-500/15 text-amber-300 text-[10px] font-bold px-2 py-0.5 rounded-full border border-amber-400/30 shrink-0">
                  <span className="hidden xs:inline">by ABU ASAD ALMANSI</span>
          ...
          <div className="flex items-center gap-2.5 sm:gap-3 shrink-0">
            <div className="w-[74px] sm:w-[88px] shrink-0">
              <LanguageSelector />
            </div>
            ...
            <button
              ...
              className="px-3 sm:px-4 py-2 bg-slate-900 hover:bg-slate-800 text-slate-200 hover:text-white border border-slate-700/80 rounded-xl text-xs font-bold transition-all cursor-pointer shadow-sm shrink-0"
            >
              Client Login
            </button>
            ...
            <button
              ...
              className="px-3.5 sm:px-5 py-2 sm:py-2.5 bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 active:from-amber-600 text-slate-950 font-black rounded-xl text-xs sm:text-sm tracking-tight transition-all shadow-lg shadow-amber-500/20 cursor-pointer shrink-0 flex items-center gap-1.5"
            >
