...
import classicTaCourseImg from '../assets/images/classic_ta_course_1788812018384.jpg';
import strategy144Img from '../assets/images/strategy_144_1788812031887.jpg';
import bookmapStrategyImg from '../assets/images/bookmap_orderflow_1788812047575.jpg';
import smcStrategyImg from '../assets/images/smc_strategy_setup_1788812064311.jpg';
import completeBundleImg from '../assets/images/complete_bundle_vip_1788812078384.jpg';
...
def detect_iceberg_absorption(order_book_tick, delta_threshold=500):
    ...
    if absorption_ratio > delta_threshold and trade_volume > bid_volume * 3:
      ...
      },
      {
        ...baseArticles[6],
        author: authors.abuAsad,
        title: 'إشارة ألفا VIP الحصرية: توافق سيولة مؤسسية عالي الاحتمالية على الذهب (XAUUSD) وناسداك (NQ)',
        subtitle: 'توصية تداول وتمركز استراتيجي لغرفة تداول VIP توضح مسح السيولة متعدد الأطر الزمنية ومستويات تحول غاما.',
        imageCaption: 'منظومة توصيات VIP المؤسسية SMTrading.pro - محفزات التنفيذ الفوري',
        publishedAt: '28 مايو 2026',
        readTime: '6 دقائق قراءة',
        summary: [
          'مسح سيولة مؤسسي لقيعان النطاق الآسيوي مع امتصاص هائل لدلتا التكات.',
          'توافق فجوة القيمة العادلة الصاعدة (FVG) على إطار 4 ساعات مع نقطة التحكم POC لدعم انطلاق سعري متسارع.',
          'نسبة عائد إلى مخاطرة صارمة 1 : 4.20 مع أهداف خروج مجزأة مؤسسية.'
        ],
        tradeSetup: {
          asset: 'الذهب الفوري مقابل الدولار (XAU/USD)',
          direction: 'LONG',
          timeframe: 'توافق متعدد الأطر 15د / 1س / 4س',
          entryZone: '3,240.00$ - 3,252.00$ (منطقة الطلب المؤسسي)',
          stopLoss: '3,218.00$ (أسفل مسح سيولة الجلسة الآسيوية)',
          takeProfit1: '3,320.00$ (قمة اليوم السابق / سيولة جانب الشراء)',
          takeProfit2: '3,385.00$ (امتداد فيبوناتشي الرئيسي 1.618)',
          riskReward: '1 : 4.20',
          keyCatalyst: 'جدار امتصاص مؤسسي وتسارع زخم افتتاح الجلسة الأمريكية'
        },
        content: [
          {
            sectionId: 'sec-1',
            sectionTitle: 'استراتيجية تنفيذ VIP والميزة الهيكلية للمزاد',
            paragraphs: [
              'تستهدف هذه الإشارة الحصرية تسلسل تجميع الأموال الذكية: استهداف سيولة أوامر وقف الخسارة لمتداولي التجزئة في بداية الجلسة، يليها فوراً امتصاص شرائي بملايين الدولارات.',
              'التنفيذ مشروط بتأكيد كسر الهيكل (BOS) على إطار 15 دقيقة مع تباعد إيجابي في CVD.'
            ],
            callout: {
              type: 'alpha',
              title: 'بروتوكول إدارة مخاطر مكتب VIP',
              text: 'خاطر بنسبة 1% إلى 1.5% فقط من رأس المال المخصص. قم بنقل وقف الخسارة إلى نقطة الدخول (Breakeven) فور تحقيق الهدف الأول (3,320.00$).'
            }
          }
        ],
        tags: ['توصيات VIP', 'ذهب', 'ناسداك', 'أموال ذكية', 'كتل الأوامر', 'تحول غاما']
      }
    ];
  }
  ...
  if (lang === 'ru') {
    return [
      ...
      },
      {
        ...baseArticles[6],
        author: authors.abuAsad,
        title: 'Эксклюзивный VIP Alpha Сигнал: институциональный сетап высокой вероятности по Золоту (XAUUSD) и Nasdaq (NQ)',
        subtitle: 'Торговый сетап VIP деска: мультитаймфреймовый сбор ликвидности, уровни Gamma Flip и выбивание стопов.',
        imageCaption: 'Институциональная система сигналов SMTrading VIP — триггеры исполнения в реальном времени',
        publishedAt: '28 мая 2026 г.',
        readTime: '6 мин чтения',
        summary: [
          'Институциональный сбор стоп-лоссов на минимумах азиатского диапазона с масштабным поглощением тиковой дельты.',
          'Слияние бычьего имбаланса (FVG 4H) и точки контроля POC, обеспечивающее ускоренный импульсный выход.',
          'Строгое соотношение риск/прибыль 1 : 4.20 с частичной фиксацией прибыли.'
        ],
        tradeSetup: {
          asset: 'Спот Золото / Доллар США (XAU/USD)',
          direction: 'LONG',
          timeframe: 'Конфлюэнция 15М / 1Ч / 4Ч',
          entryZone: '$3,240.00 - $3,252.00 (Зона институционального спроса)',
          stopLoss: '$3,218.00 (Ниже азиатского свипа ликвидности)',
          takeProfit1: '$3,320.00 (Максимум предыдущего дня / Стоп-ликвидность)',
          takeProfit2: '$3,385.00 (Ключевое расширение Фибоначчи 1.618)',
          riskReward: '1 : 4.20',
          keyCatalyst: 'Стена поглощения институционального деска и импульс открытия сессии в США'
        },
        content: [
          {
            sectionId: 'sec-1',
            sectionTitle: 'Стратегия входа VIP и микроструктурное преимущество',
            paragraphs: [
              'Данный VIP-сигнал захватывает классическую фазу аккумуляции Smart Money: сбор стоп-ордеров ритейл-трейдеров в начале сессии с последующим мгновенным поглощением пассивными институциональными бидами.',
              'Вход осуществляется строго при подтверждении слома структуры (BOS 15M) и бычьей дивергенции кумулятивной дельты (CVD).'
            ],
            callout: {
              type: 'alpha',
              title: 'Протокол риск-менеджмента VIP деска',
              text: 'Риск строго 1.0%–1.5% от выделенного депозита. Перевод стоп-лосса в безубыток при достижении первой цели ($3,320.00).'
            }
          }
        ],
        tags: ['VIP Сигналы', 'Золото', 'Nasdaq', 'Smart Money', 'Ордерблоки', 'Gamma Flip']
      }
    ];
  }
  ...
  if (lang === 'uk') {
    return [
      ...
      },
      {
        ...baseArticles[6],
        author: authors.abuAsad,
        title: 'Ексклюзивний VIP Alpha Сигнал: інституційний сетап високої ймовірності по Золоту (XAUUSD) та Nasdaq (NQ)',
        subtitle: 'Торговий сетап VIP деску: мультитаймфреймовий збір ліквідності, рівні Gamma Flip та зняття стоп-лосів.',
        imageCaption: 'Інституційна система сигналів SMTrading VIP — тригери виконання в реальному часі',
        publishedAt: '28 травня 2026 р.',
        readTime: '6 хв читання',
        summary: [
          'Інституційний збір стоп-лосів на мінімумах азіатського діапазону з масштабним поглинанням тикової дельти.',
          'Злиття бичачого імбалансу (FVG 4H) та точки контролю POC для прискореного імпульсного виходу.',
          'Суворе співвідношення ризик/прибуток 1 : 4.20 з частинною фіксацією прибутку.'
        ],
        tradeSetup: {
          asset: 'Спот Золото / Долар США (XAU/USD)',
          direction: 'LONG',
          timeframe: 'Конфлюенція 15ХВ / 1ГОД / 4ГОД',
          entryZone: '$3,240.00 - $3,252.00 (Зона інституційного попиту)',
          stopLoss: '$3,218.00 (Нижче азіатського свіпу ліквідності)',
          takeProfit1: '$3,320.00 (Максимум попереднього дня / Стоп-ліквідність)',
          takeProfit2: '$3,385.00 (Ключове розширення Фібоначчі 1.618)',
          riskReward: '1 : 4.20',
          keyCatalyst: 'Стіна поглинання інституційного деску та імпульс відкриття сесії в США'
        },
        content: [
          {
            sectionId: 'sec-1',
            sectionTitle: 'Стратегія входу VIP та мікроструктурна перевага',
            paragraphs: [
              'Даний VIP-сигнал захоплює класичну фазу акумуляції Smart Money: збір стоп-ордерів рітейл-трейдерів на початку сесії з наступним миттєвим поглинанням пасивними інституційними бідами.',
              'Вхід здійснюється суворо при підтвердженні злому структури (BOS 15M) та бичачої дивергенції кумулятивної дельти (CVD).'
            ],
            callout: {
              type: 'alpha',
              title: 'Протокол ризик-менеджменту VIP деску',
              text: 'Ризик суворо 1.0%–1.5% від виділеного депозиту. Переведення стоп-лосу в безубиток при досягненні першої цілі ($3,320.00).'
            }
          }
        ],
        tags: ['VIP Сигнали', 'Золото', 'Nasdaq', 'Smart Money', 'Ордерблоки', 'Gamma Flip']
      }
    ];
  }
